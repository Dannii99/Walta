...
function GitHubIcon() {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      className="h-4 w-4 text-stone-900 dark:text-stone-50"
    >
...
const LABELS: Record<OAuthButtonProps["provider"], string> = {
  google: "Google",
  github: "GitHub",
};
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "border border-stone-300 dark:border-stone-700 bg-white dark:bg-stone-900/50",
