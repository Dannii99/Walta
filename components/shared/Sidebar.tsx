  ...
  return (
    <aside
      className={cn(
        ...
        "bg-gradient-to-br from-[#17181c] to-[#333438] rounded-r-2xl shadow-[4px_0_24px_rgba(0,0,0,0.15)]"
      )}
    ...
    >
      ...
      >
        ...
        <div className="ml-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap overflow-hidden">
          ...
          <p className="text-[9px] font-bold uppercase tracking-wider text-[#737373] mt-1">
            Tu dinero, más claro.
          </p>
        </div>
      </Link>
      ...
      <nav className="flex-1 px-3 py-5 space-y-1 overflow-y-auto scrollbar-none">
        <p className="px-3 mb-2 text-[9px] font-bold uppercase tracking-wider text-[#737373] opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
          Navegación
        </p>
        {navItems.map((item) => {
          const isActive =
            ...
            >
              {isActive && (
                <motion.span
                  ...
                  className="absolute -left-3 top-1/2 -translate-y-1/2 h-6 w-[3px] rounded-r-full bg-[#26be15]"
              ...
              <div
                className={cn(
                  ...
                  isActive
                    ...
                    : "text-[#a1a1aa] group-hover/nav:text-white"
                )}
              >
      ...
      <div className="p-3 border-t border-white/10 space-y-1 shrink-0">
        ...
        <Button
          ...
          className="w-full justify-start gap-0 h-10 px-[10px] text-[#a1a1aa] hover:text-white hover:bg-white/10"
        >
