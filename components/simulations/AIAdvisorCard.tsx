...
import { generateSimulationAdvice } from "@/server/actions/ai-actions";
...
export function AIAdvisorCard({ simulationId }: AIAdvisorCardProps) {
  ...
  const loadAdvice = () => {
    startTransition(async () => {
      try {
        const res = await generateSimulationAdvice(simulationId);
