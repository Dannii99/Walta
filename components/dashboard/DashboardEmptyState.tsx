...
export function DashboardEmptyState() {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-8 md:p-12 shadow-xl ring-1 ring-black/5"
    >
      ...
      <div className="relative flex flex-col items-center text-center max-w-2xl mx-auto space-y-6">
        <div className="flex h-20 w-20 items-center justify-center rounded-3xl bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-500 text-white shadow-xl shadow-indigo-500/30 ring-4 ring-white/40">
        ...
        <div className="space-y-2">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-900 bg-clip-text text-transparent">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-4 w-full">
          <div className="flex items-start gap-2.5 rounded-xl bg-white/60 backdrop-blur p-3 border border-white/80">
            ...
            <div className="text-left">
              <p className="text-xs font-bold text-foreground/90">Salud 50/30/20</p>
          ...
          <div className="flex items-start gap-2.5 rounded-xl bg-white/60 backdrop-blur p-3 border border-white/80">
            ...
            <div className="text-left">
              <p className="text-xs font-bold text-foreground/90">Distribución clara</p>
              <p className="text-[11px] text-muted-foreground leading-snug">
          ...
          <div className="flex items-start gap-2.5 rounded-xl bg-white/60 backdrop-blur p-3 border border-white/80">
            ...
            <div className="text-left">
              <p className="text-xs font-bold text-foreground/90">Recomendaciones</p>
              <p className="text-[11px] text-muted-foreground leading-snug">
