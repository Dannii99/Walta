    ...
    <DashboardProvider>
      <div className="min-h-screen bg-[#FAF9F7] dark:bg-stone-950">
        ...
        <main className="md:pl-[68px] pb-20 md:pb-0 min-w-0">
          <div className="md:hidden sticky top-0 z-30 flex items-center gap-2 px-4 h-14 border-b border-[#E8E5E0]/80 dark:border-stone-800 bg-[#FAF9F7]/90 dark:bg-stone-950/90 backdrop-blur-md">
